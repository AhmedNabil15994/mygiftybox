...
var drivers_1 = __webpack_require__(30);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(66).setImmediate))
...
var editors_1 = __webpack_require__(77);
var html_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
var JsonDriver_1 = __webpack_require__(31);
var CsvDriver_1 = __webpack_require__(32);
var XMLDriver_1 = __webpack_require__(69);
exports.dataDrivers = {
...
var Cells_1 = __webpack_require__(16);
...
var ts_data_1 = __webpack_require__(5);
var Exporter_1 = __webpack_require__(75);
var data_1 = __webpack_require__(10);
var cells_1 = __webpack_require__(19);
var main_1 = __webpack_require__(7);
var Selection_1 = __webpack_require__(76);
var types_1 = __webpack_require__(3);
var render_1 = __webpack_require__(35);
var date_1 = __webpack_require__(15);
var content_1 = __webpack_require__(102);
var columnsResizer_1 = __webpack_require__(103);
var ts_message_1 = __webpack_require__(53);
...
var main_1 = __webpack_require__(7);
var Cells_1 = __webpack_require__(16);
var FixedCols_1 = __webpack_require__(51);
var FixedRows_1 = __webpack_require__(52);
var core_1 = __webpack_require__(1);
var BORDERS = 2;
...
function getGridData(renderConfig, shifts) {
    ...
    var columns = renderConfig.columns, $resizing = renderConfig.$resizing, $totalHeight = renderConfig.$totalHeight, $totalWidth = renderConfig.$totalWidth, leftSplit = renderConfig.leftSplit, data = renderConfig.data, $positions = renderConfig.$positions, currentRows = renderConfig.currentRows, currentColumns = renderConfig.currentColumns, eventHandlers = renderConfig.eventHandlers;
    ...
    function getCellInfo(e) {
        ...
        var row = currentRows.filter(function (item) { return item.id.toString() === rowId; })[0];
        var col = currentColumns.filter(function (item) { return item.id === colId; })[0];
        return {
            row: rowId ? row : {},
            col: colId ? col : {},
        };
...
var Cell_1 = __webpack_require__(38);
var dom_1 = __webpack_require__(0);
...
var events_1 = __webpack_require__(4);
var ts_grid_1 = __webpack_require__(33);
...
var editors_1 = __webpack_require__(96);
exports.MOVE_UP = 1;
exports.MOVE_DOWN = 2;
...
// WIDGETS
var Tree_1 = __webpack_require__(113);
exports.Tree = Tree_1.Tree;
var ts_menu_1 = __webpack_require__(116);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(68)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var xml_1 = __webpack_require__(70);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var datacollection_1 = __webpack_require__(29);
var dataproxy_1 = __webpack_require__(13);
var helpers_1 = __webpack_require__(9);
var types_1 = __webpack_require__(8);
...
var html_1 = __webpack_require__(2);
var ts_grid_1 = __webpack_require__(33);
var CollectionStore_1 = __webpack_require__(110);
var types_1 = __webpack_require__(8);
var helpers_1 = __webpack_require__(9);
var core_1 = __webpack_require__(1);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype._toHTML = function (row, column, last) {
        ...
        if (isFixedCol) {
            ...
            minWidth = fixedCols
                .splice((_a = this._grid.config.columns) === null || _a === void 0 ? void 0 : _a.indexOf(column))
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(3);
var InputEditor_1 = __webpack_require__(78);
var SelectEditor_1 = __webpack_require__(79);
var DateEditor_1 = __webpack_require__(80);
var CheckboxEditor_1 = __webpack_require__(93);
var ComboboxEditor_1 = __webpack_require__(94);
var TextAreaEditor_1 = __webpack_require__(101);
var lastEditor = {
    cell: {
        row: null,
        col: null,
...
var dom_1 = __webpack_require__(0);
var types_1 = __webpack_require__(3);
var ts_calendar_1 = __webpack_require__(36);
var date_1 = __webpack_require__(15);
var ts_popup_1 = __webpack_require__(20);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(6);
var ts_timepicker_1 = __webpack_require__(82);
...
var view_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(24);
var ts_slider_1 = __webpack_require__(87);
var en_1 = __webpack_require__(90);
...
var ProCell_1 = __webpack_require__(86);
...
Object.defineProperty(exports, "__esModule", { value: true });
var InputEditor_1 = __webpack_require__(97);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Grid_1 = __webpack_require__(34);
var types_1 = __webpack_require__(3);
var ts_data_1 = __webpack_require__(5);
var html_1 = __webpack_require__(2);
var data_1 = __webpack_require__(10);
...
var KeyManager_1 = __webpack_require__(12);
var FocusManager_1 = __webpack_require__(14);
var types_2 = __webpack_require__(115);
...
var Tree = /** @class */ (function (_super) {
    ...
    Tree.prototype._initEvents = function () {
        ...
        this.events.on(ts_data_1.DragEvents.dragStart, function (data, e) {
            _this._scroll.elem = html_1.locateNode(e, "data-dhx-root-id");
            _this._autoScroll(_this._scroll);
    ...
    Tree.prototype._autoScroll = function (config) {
        var elem = config.elem;
        if (elem) {
            var elemRect = elem.getBoundingClientRect();
            var elemTop_1 = elemRect.top, elemBottom_1 = elemRect.bottom, elemHeight = elemRect.height;
            var elemScrollHeight = elem.scrollHeight;
            var timerId_1 = null;
            var scroll_1 = function (config) {
                var elem = config.elem, step = config.step, delay = config.delay, direction = config.direction;
                return setInterval(function () {
                    elem.scrollBy(0, direction === types_2.Direction.up ? -step : step);
                }, delay);
            };
            var handler_1 = function (e) {
                var mousePosition = e.clientY;
                if (mousePosition > elemBottom_1) {
                    if (!timerId_1) {
                        timerId_1 = scroll_1(__assign(__assign({}, config), { direction: types_2.Direction.down }));
                    }
                }
                else if (mousePosition < elemTop_1) {
                    if (!timerId_1) {
                        timerId_1 = scroll_1(__assign(__assign({}, config), { direction: types_2.Direction.up }));
                    }
                }
                else if (timerId_1) {
            ...
            if (elemHeight < elemScrollHeight) {
                document.addEventListener("pointermove", handler_1);
                document.addEventListener("pointerup", function () {
                    document.removeEventListener("pointermove", handler_1);
                    clearInterval(timerId_1);
                    timerId_1 = null;
                }, { once: true });
            }
    ...
    Tree.prototype._initHandlers = function () {
        ...
        if (evs) {
            for (var _i = 0, _a = Object.entries(evs); _i < _a.length; _i++) {
                var _b = _a[_i], event_name = _b[0], events = _b[1];
                this._handlers[event_name] = html_1.eventHandler(function (event) {
    ...
    Tree.prototype._dragStart = function (event) {
        if (this.config.dragMode && this.config.dragMode !== "target") {
            ...
            this._touch.start = true;
            ts_data_1.dragManager.onMouseDown(event);
        }
    };
    ...
    Tree.prototype._drawItems = function (parent, level) {
        ...
        return order.map(function (item) {
            ...
            if (item.checkbox) {
                ...
                _this.events.fire(types_1.SelectionEvents.afterSelect, []);
            ...
            if (_this.config.template) {
                ...
                itemValue =
                    typeof template === "string"
                        ? dom_1.el("div.dhx_tree-template__wrapper", {
                            ".innerHTML": template,
                        })
                        : itemValue;
            }
    ...
    Tree.prototype._updateItemCheck = function (id, status) {
        ...
        // this.events.fire(TreeEvents.afterCheck, [id]);
    ...
    Tree.prototype._initHotkeys = function () {
        ...
        var getClosestBot = function (id, ignore) {
            ...
            if (haveItems && item.opened && !ignore) {
                ...
                var childs = _this.data.getItems(parent_1);
                ...
                if (index + 1 < len) {
                    ...
                    if (parent_1 === _this.data.getRoot()) {
                        return null;
                    }
                    return getClosestBot(parent_1, true);
                }
            }
        };
...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype._draw = function () {
        ...
        if (this.config.mode === EditorMode.selectItem) {
            ...
            return dom_1.el("div.dhx_tree-editor", {
                _hooks: {
                    didInsert: this._handlers.didInsert,
                },
                id: "input_" + this._item.id,
...
var html_1 = __webpack_require__(2);
var ts_message_1 = __webpack_require__(53);
var ts_navbar_1 = __webpack_require__(56);
        ...
        this._handlers = __assign({ onmousemove: function (e) {
                ...
                if (_this.config.navigationType !== "click") {
                    ...
                    if (_this._popupActive) {
                        var element = html_1.locateNode(e, "data-dhx-id", "relatedTarget");
                        if (element) {
...
var navItem_1 = __webpack_require__(121);
var customHTMLButton_1 = __webpack_require__(122);
var imageButton_1 = __webpack_require__(123);
var input_1 = __webpack_require__(124);
var menuItem_1 = __webpack_require__(125);
var separator_1 = __webpack_require__(126);
var spacer_1 = __webpack_require__(127);
var title_1 = __webpack_require__(128);
var datePicker_1 = __webpack_require__(129);
...
function button(item, widgetName) {
    ...
    return dom_1.el("button.dhx_button", __assign({ class: helpers_1.getNavbarButtonCSS(item, widgetName), "data-dhx-id": item.id, disabled: item.disabled, type: "button" }, getAriaAttrs(item)), [
...
function customHTMLButton(item, widgetName, asMenuItem) {
    ...
    return dom_1.el("button", __assign({ class: "dhx_custom-button" + baseClass + (item.$activeParent ? baseClass + "--active" : ""), "data-dhx-id": item.id, type: "button", ".innerHTML": item.html }, getAriaAttrs(item)), item.html ? "" : item.value);
}
...
function input(item, events, widgetName) {
    return dom_1.el(".dhx_form-group.dhx_form-group--no-message-holder" +
