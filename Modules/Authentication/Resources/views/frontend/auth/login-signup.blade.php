            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="login-form signin-block">
                        ...
                        <form class="login" method="post" action="{{ route('frontend.register') }}" onsubmit="setCode()">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="text" name="mobile" id="mobile"
                                       ...
                                       {{--pattern="[0-9]+"--}}
                                       {{--maxlength="8"--}}
                                       value="{{ old('mobile') }}" class="inputTel">
                                <input type="hidden" id="country_code" name="country_code">
                                <input type="hidden" id="calling_code" name="calling_code">
...
@push('scripts')
    ...
    <script>
        ...
        function setCode() {
            $("#calling_code").val((iti1.getNumber().replace('+','')).replace($('input[name="mobile"]').val() , '') );
        }
    </script>
@endpush
