...
<div class="container">
    ...
    <div class="inner-page">
        <form method="post" class="base_div" enctype="multipart/form-data" action="{{ route('frontend.orders.create_order') }}" onsubmit="getCallingCode()" id="checkout-form">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="cart-inner">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group">
                                    {!!
                                    field('frontend_no_label')->text('mobile',__('user::frontend.addresses.form.mobile'),null,[
...
<script>
    ...
    function getCallingCode(){
        ...
        $(".base_div input[name='calling_code']").val(baseNumber.replace(newNumber,''));
    }
