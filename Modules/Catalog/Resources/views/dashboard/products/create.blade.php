                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="single">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span id="offerPercentageSection" style="display: none">
                                            ...
                                            {!! field()->file('image' , __('catalog::dashboard.products.form.image')) !!}
                                ...
                                @if(config('setting.products.toggle_variations') == 1)
                                    <div class="tab-pane fade in multiple hidden" id="variations">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($options as $option)
                                                <div class="{{$option->values()->where('type','color')->count() ? "col-md-12" : "col-md-6"}}">
                                ...
                                <div class="tab-pane fade in" id="categories">
                                    ...
                                    <div id="jstree">
                                       ...
                                       $mainCategories,'type'=>'create'])
                                    </div>
                                    <div class="form-group">
                                        <input type="hidden" name="category_id" id="root_category" value="1"
                                    ...
                                    <div class="blog-single-sidebar bordered blog-container">
                                        ...
                                        <div id="select_countries"
                                            ...
                                            {!! field('side_fields')->multiSelect('countries' ,
                                                __('catalog::dashboard.products.form.shipping_to'),$supported_countries->pluck('title','id')->toArray(),
                                            ...
                                            <div id="product-images">
                                                ...
                                                <div id="prd-image-0" class="prd-image-section">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn btn-danger btnRemoveMore" onclick="removeMoreImage(0, 0, 'row')">X
                                                        </button>
                                                    </div>
                        ...
                        <div class="col-md-12 text-right">
                            <div class="form-actions col-md-11 " style="margin-top: 30px;">
