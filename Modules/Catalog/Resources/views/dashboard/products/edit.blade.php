...
{{--                                                </li>--}}
                                                ...
                                                @if(config('setting.products.toggle_variations') == 1)
                                                    <li class="multiple {{ isset($product) && $product->variants()->count() ? '' : 'hidden'   }}">
                                                ...
                                                <li class="">
                                                    <a href="#delivery_info" data-toggle="tab">
                                                        {{ __('catalog::dashboard.products.form.tabs.delivery_info') }}
                                                    </a>
                                                </li>
                        ...
                        <div class="col-md-8">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        @foreach (config('translatable.locales') as $code)
                                            <div id="global_setting{{$code}}"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    __('catalog::dashboard.products.form.description').'-'.$code,$product->getTranslation('description',$code)); !!}
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="single {{ isset($product) && $product->variants()->count() ? 'hidden' : ''   }}">
                                                <div class="form-group">
                                                    <label class="col-md-2">
                                                        {{__('catalog::dashboard.products.form.price')}}
                                                    </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="price" class="form-control" value="{{$product->price ?? 0}}" data-name="price">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <span id="offerAmountSection" style="display: {{$product->offer && is_null($product->offer->percentage) || is_null($product->offer) ? 'block' : 'none'}}">
                                                    ...
                                                    <span id="offerPercentageSection" style="display: {{$product->offer && $product->offer->percentage ? 'block' : 'none'}}">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" step="0.5" min="0" id="offer-percentage-form"
                                                                   ...
                                                                   data-name="offer_percentage" value="{{$product->offer ? $product->offer->percentage : ''}}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </span>
                                                    <select class="form-control input-xsmall inline-selector" style="padding:0px 0px" name="offer_type" onchange="toggleOfferType($(this).val())">
                                                        <option value="amount">
                                                            {{ __('catalog::dashboard.products.form.offer_type.amount') }}
                                                        </option>
                                                        <option value="percentage" {{$product->offer && $product->offer->percentage ? 'selected' : ''}}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="offerDateRange"  class="col-md-9 btn default">
                                                        <i class="fa fa-calendar"></i> &nbsp;
                                                        <span>
                                                            @if($product->offer)
                                                                {{$product->offer->start_at  . ' - ' . $product->offer->end_at}}
                                                            @endif
                                                        </span>
                                                        <b class="fa fa-angle-down"></b>
                                                        <input type="hidden" value="{{$product->offer ? $product->offer->start_at : ''}}" name="start_at">
                                                        <input type="hidden" value="{{$product->offer ? $product->offer->end_at : ''}}" name="end_at">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2">
                                                        {{__('catalog::dashboard.products.form.select_qty')}}
                                                    </label>
                                                    <div class="col-md-2">
                                                        <input data-size="small" type="checkbox"
                                                               name="manage_qty" class="make-switch manageQty"
                                                               data-name="manage_qty"
                                                               onchange="manageQty(this)"
                                                               value="limited" {{ !is_null($product->qty) ? 'checked' : '' }}>
                                                        <div class="help-block"></div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-7" style="padding: 0">
                                                        <span>
                                                            <input type="number" id="prdQty" name="qty"
                                                                   ...
                                                                   data-name="qty" style="display: {{ !is_null($product->qty) ? 'block' : 'none' }};">
                                                            <div class="help-block"></div>
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade in" id="delivery_info">
                                    <h3 class="page-title">{{__('catalog::dashboard.products.form.tabs.delivery_info')}}</h3>
                                    <div class="blog-single-sidebar bordered blog-container">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('catalog::dashboard.products.form.all_countries')}}
                                            </label>
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="all_countries"
                                                       data-size="small"
                                                       name="all_countries" {{($product->all_countries == 1) ? ' checked="" ' : ''}}>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
...
{{--                                </div>--}}
                                ...
                                @if(config('setting.products.toggle_variations') == 1)
                                    <div class="tab-pane fade in multiple  {{ isset($product) && $product->variants()->count() ? '' : 'hidden'   }}" id="variations">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($options as $option)
                                                ...
                                                <div class="{{$option->values()->where('type','color')->count() ? "col-md-10" : "col-md-5"}}" style="margin: 0 0 0 10px;">
                                                    <div class="form-group">
                                                        ...
                                                        @else
                                                            ...
                                                            <div style="margin:10px">
                                                                @foreach (optional($option)->values as $value)
                                                                    <label class="mt-checkbox col-md-2"
                                ...
                                <button type="button" class="btn btn-lg green load_variations">
                                    ...
                                    {{__('catalog::dashboard.products.form.add_variations')}}
                                        ...
                                        <div id="copy-vairations">
                                            <hr>
                                            @php $options = ['price','qty','status','weight','width','length','height','offer_status','offer_price','start_at','end_at'];@endphp

                                            <div class="copy-options md-radio-inline">
                                                @foreach($options as $option)
                                                    <label class="mt-checkbox" style="margin-right: 5px;margin-left: 5px;">
                                                        <input class="copy-option" type="checkbox" name="copy_options" value="{{$option}}-variation">
                                                        {{__('catalog::dashboard.products.form.'.$option)}}
                                                        <span></span>
                                                    </label>
                                                @endforeach
                                                <label class="mt-checkbox" >
                                                    <input class="select-variation-all" type="checkbox"  name="select-variation-all" id="select-variation-all">
                                                    {{__('catalog::dashboard.products.form.select_all')}}
                                                    <span></span>
                                                </label>
                                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        let end = NaN;
        @if($product->offer)
            start = moment("{{$product->offer->start_at}}")
            end = moment("{{$product->offer->end_at}}")
        @endif
        ...
        $('#offerDateRange').daterangepicker({
            ...
            if ((isNaN(start) && isNaN(end)) || (start == null && end == null)) {
                ...
                $('#offerDateRange span').html('{{__('apps::dashboard.general.date_range.all')}}');
        ...
        //===========
        $("body").on("switchChange.bootstrapSwitch", ".offer-status", function () {
            var elm = $(this)
