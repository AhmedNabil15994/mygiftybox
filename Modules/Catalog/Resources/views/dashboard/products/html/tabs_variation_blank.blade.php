                        ...
                        <td colspan="5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 text-left">
                                    <input type="checkbox" class="offer-status make-switch offer-status-variation"
                                           data-size="small" data-index="{{$key2}}"
                            ...
                            <div class="offer-form_{{$key2}} variation_offer" style="display:none;margin-top: 10px;">
                    ...
                    <tr class="variation_options_{{$key2}}">
                        <td colspan="5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 text-left">
                                    <input type="checkbox" class="offer-status make-switch offer-status-variation" data-size="small" data-index="{{$key2}}"
                                           name="v_offers[{{ $key2 }}][status]" data-name="v_offers.{{ $key2 }}.status">
                                    <div class="help-block"></div>
                                </div>
                            </div>
