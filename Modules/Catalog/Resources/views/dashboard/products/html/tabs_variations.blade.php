<div class="portlet-body variation-container variation-edit">
    <div class="table-container">
        <table class="table table-striped table-bordered table-hover table-checkable edit-table" id="datatable_ajax">
            <thead>
            ...
            @foreach ($product->variants as $key => $data)
                ...
                <tr class="variation_options_update_{{$data['id']}}">
                    <td colspan="5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 text-left">
                                <input type="checkbox"
                                       ...
                                       @endif
                                       class="offer-status make-switch offer-status-variation" data-size="small" data-index="update{{$data['id']}}"
                        ...
                        <div class="offer-form_update{{$data['id']}} variation_offer" style="display:none;margin-top:10px">
