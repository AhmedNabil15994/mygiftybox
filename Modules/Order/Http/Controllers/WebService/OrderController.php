...
//    }
    ...
    public function paymentMethods()
    {
        $paymentExceptions = ['payment_mode'];
        ...
        return $this->response($customSupportedPayments);
    }
    ...
    public function myfatoorahWebhooks(Request $request){
        logger('MyFatoorah::Webhooks');
        logger($request->all());
